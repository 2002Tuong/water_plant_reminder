...
package com.example.waterplant.common.tflite;

import static com.example.waterplant.common.env.Utils.expit;
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public float getObjThresh() {
        return DiagnoseActivity.MINIMUM_CONFIDENCE_TF_OD_API;
    }
